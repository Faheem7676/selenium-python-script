...
All most commonly used utitlities should be implemented in this class
...
class Util(object):
	...
	def getAlphaNumeric(self,length,type="letters"):
		...
		Parameters:
		    ...
		    Provider lower/upper/digits for different types
		"""
	...
	def getUniqueNameList(self,listSize=5,itemLength=None):
		...
		parameters:
		    ...
		    listSize: Number of names. Dafault is 5 names in a list
		    itemLength: It should be a list containing number of items equal to the listSize
		            This determines the length of the each item in th list ->[1,2,3,4,5]
	...
	def verifyTextMatch(self,actualText,expectedText):
		...
		Parameters:
		    expectedList: Expceted Text
		    actualList : Actual Text
		"""

		self.log.info("Actual Text From Application Web UI --> :: " +actualText)
		sleep.log.info("Expceted Text From Application Web UI -->:: "+ expectedText)
		if actualText.lower()==expectedText.lower():
			sleep.log.info("### VERIFICATION MATCHED!!!")
			return True
		else:
